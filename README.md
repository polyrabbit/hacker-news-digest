...
Summaries are primarily generated by a remote LLM service, with local Qwen as fallback when remote inference is unavailable.
...
* 📰: summary model - the model used to generate the summary
